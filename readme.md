...
![foreshortening](readme_media/foreshortening.png | width=100)
...
![texture mapping](readme_media/texture_mapping.png | width=100)
...
![cube in space](readme_media/bleak_renderer.png | width=100)
...
## light and color
![xkcd Color Models](readme_media/xkcd_color.png.png | width=100)
